        ...
        */
        ...
        public void ClearSiloMOutTable(String strName, String strDays, dbOperation dbOperationLocalHost)
        {
            ...
            if (bDays)
            {
                ...
                try
                {
                    ...
                    if (b)
                    {
                        lm.ShowMsg("清除 P_SILO_M_OUT 表成功.");
                    }
                    else
                    {
                        lm.ShowMsg("清除 P_SILO_M_OUT 表成功.");
                ...
                {
                    lm.ShowMsg("清除 P_SILO_M_OUT 表-异常！错误提示：" + ex.ToString());
                }
            }
        }
        /*
        ...
        public void ClearSiloMINTable(String strName, String strDays, dbOperation dbOperationLocalHost)
        {
            ...
            if (bDays)
            {
                ...
                {
                    lm.ShowMsg("清除 P_SILO_M_IN 表-异常！错误提示：" + ex.ToString());
                }
            }
        }
        /*
        ...
        public void ClearFastLsOutTable(String strName, String strDays, dbOperation dbOperationLocalHost)
        {
            ...
            if (bDays)
            {
                ...
                try
                {
                    ...
                    if (b)
                    {
                        lm.ShowMsg("清除 P_FAST_LS_IN 表成功.");
                    }
                    else
                    {
                        lm.ShowMsg("清除 P_FAST_LS_IN 表成功.");
                ...
                {
                    lm.ShowMsg("清除 P_FAST_LS_IN 表-异常！错误提示：" + ex.ToString());
                }
            }
        }
        /*
